...
public class GenericArrow extends ArrowItem implements ICEquipment {
    public final ArrowDataBuilder builder;

    public GenericArrow(Properties pProperties, ArrowDataBuilder builder) {
        super(pProperties);
        this.builder = builder;
    }

    public GenericArrow(Item.Properties pProperties, double defaultDamage) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> list, TooltipFlag pIsAdvanced) {
        list.add(GenericBow.bowDamage.withColor(ChatFormatting.BLUE, TooltipEntry.num((int) this.builder.damage)));
    ...
    public void onCreateSource(GenericArrow arrow, CreateSourceEvent event) {
    }
