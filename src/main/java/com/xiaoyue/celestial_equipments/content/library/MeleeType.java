...
public enum MeleeType {
    ...
    public static final TooltipEntry meleeTypeBroad = TooltipEntry.define("Sword type: broad");

    @SubscribeTooltip(id = "melee_type_generic")
    public static final TooltipEntry meleeTypeGeneric = TooltipEntry.define("Sword type: generic");

    @SubscribeTooltip(id = "melee_type_small")
    public static final TooltipEntry meleeTypeSmall = TooltipEntry.define("Sword type: small");

    public MutableComponent getLang() {
        MutableComponent text;
        switch (this) {
            case BROAD -> text = meleeTypeBroad.withColor(ChatFormatting.BLUE);
            case GENERIC -> text = meleeTypeGeneric.withColor(ChatFormatting.BLUE);
            case SMALL -> text = meleeTypeSmall.withColor(ChatFormatting.BLUE);
            default -> throw new IncompatibleClassChangeError();
        }
        return text;
    }
