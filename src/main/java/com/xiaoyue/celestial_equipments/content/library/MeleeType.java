...
public enum MeleeType {
    ...
    public MutableComponent getLang() {
        ...
        switch (this) {
            case BROAD -> text = meleeTypeBroadTooltip.withColor(ChatFormatting.BLUE);
            case GENERIC -> text = meleeTypeGenericTooltip.withColor(ChatFormatting.BLUE);
            case SMALL -> text = meleeTypeSmallTooltip.withColor(ChatFormatting.BLUE);
            default -> throw new IncompatibleClassChangeError();
        }
        return text;
    }
