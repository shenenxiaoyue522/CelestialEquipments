...
public class EquipmentUtils {
    ...
    public static TooltipEntry equipmentLevel = TooltipEntry.define("Equipment's rank: %s");

    @SubscribeTooltip(id = "equipment_exp")
    public static TooltipEntry equipmentExp = TooltipEntry.define("Equipment's experience: %s / %s");
    ...
    public static void addExpTooltips(List<Component> list, ItemStack stack) {
        list.add(equipmentLevel.withGray(TooltipEntry.num(getLevel(stack))));
        list.add(equipmentExp.withGray(TooltipEntry.num(getExp(stack)), TooltipEntry.num(getMaxExp())));
    }

    public static void addBowStatsTooltips(List<Component> list, float damage, float drawSpeed, float arrowSpeed) {
        list.add(UpgradeableBow.bowDamage.withColor(ChatFormatting.BLUE, TooltipEntry.num(damage)));
        list.add(UpgradeableBow.drawSpeed.withColor(ChatFormatting.BLUE, TooltipEntry.num(drawSpeed)));
        list.add(UpgradeableBow.arrowSpeed.withColor(ChatFormatting.BLUE, TooltipEntry.chance(arrowSpeed)));
    }
